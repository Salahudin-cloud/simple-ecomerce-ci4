...
<body>
  ...
  <div class="container mt-3">
    <h1>Resupply Product</h1>
    <p>This is page update form that handle resupply product by admin </p>
    <div class="container-fluid">
      <div class="row justify-content-start">
        <div class="col-md-6 col-lg-4 custom-form-width">
          <form action="<?php echo base_url('menu/product_manager/update/supply/product/process/' . $product->id); ?>" method="post">
            <!-- Hidden input field for the _method parameter -->
            <input type="hidden" name="_method" value="PUT">

            <input type="hidden" name="date" id="date" value="<?php echo date("Y/m/d h:i:s A") ?>">

            <div class="mb-3">
              <label for="" class="form-label">Product Name :</label>
              <input type="text" class="form-control shadow-none " id="productName" readonly name="productName" value="<?php echo $product->product_name ?>" autocomplete="off">
            </div>
            <div class="mb-3">
              <label for="" class="form-label">New Stock :</label>
              <input type="number" class="form-control " id="stock" name="stock" value="" autocomplete="off">
            </div>
            <div class="mb-3">
              <label for="" class="form-label">Price :</label>
              <input type="text" class="form-control shadow-none " id="price" readonly name="price" value="<?php echo $product->price ?>" autocomplete="off">
            </div>
